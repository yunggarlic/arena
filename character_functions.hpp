...
public:
  ...
  Character(string new_name, int new_strength, int new_intellect, int new_health, int new_defense, int new_renown = 0, int new_level = 1, int new_experience = 0);
  ...
  void renown_adjustment(Character enemy, string operation);
  void regain_health();
};
